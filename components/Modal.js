...
const Modal = () => {
    ...
    return (
        <div className="fixed to-0 left-0 z-[20] h-screen w-screen bg-[#242d34bb]" onClick={closeModal}>
            ...
            <div className="bg-white dark:bg-black w-[350px] md:w-[650px] text-black dark:text-white absolute left-[50%] translate-x-[-50%] mt-[40px] p-4 rounded-[20px]"
                ...
                <div className="relative mt-8 grid grid-cols-[48px,1fr] gap-4">
                    ...
                    <div className="mt-4">
                        ...
                        <div className="flex justify-between items-center">
                            ...
                            <button
                                className="bg-[#1d9bf0] text-white rounded-full px-4 py-1.5 font-bold shadow-md hover:bg-[#1a8cd8] disabled:hover:bg-[#1d9bf0] 
