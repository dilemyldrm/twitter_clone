...
function Comment({ comment }) {
    return (
        <div className="p-3 flex cursor-pointer border-b dark:border-gray-700"> 
            <img src={comment?.userImg} alt="" className="h-11 w-11 rounded-full mr-4" />
            <div className="flex flex-col space-y-2 w-full"> 
                <div className="flex justify-between"> 
                    <div className="text-[#6e767d]"> 
                        <div className="inline-block group"> 
                            <h4 className="font-bold dark:text-[#d9d9d9] text-[15px] sm:text-base inline-block group-hover:underline"> 
                                {comment?.username}                           
                            </h4>
                        ...
                        <p className="dark:text-[#d9d9d9] mt-0.5 max-w-lg text-[15px] sm:text-base">
                            {comment?.comment}
                        </p>
                    </div>
