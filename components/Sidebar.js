...
import {BsBell, BsBookmark, BsThreeDots, BsTwitter, BsArrowLeft} from "react-icons/bs"
...
const Sidebar = () => {
    ...
    return (
        <div className="hidden sm:flex flex-col items-center xl:items-start xl:w-[340px] p-2 fixed h-full border-r dark:border-gray-400 pr-0 xl:pr-8">

            <div className="flex items-center justify-center w-14 h-14 hoverEffect p-0 xl:ml-24">

                <BsTwitter className="text-black dark:text-white text-[34px]" />
            ...
            <div className="dark:text-[#d9d9d9] flex items-center justify-center mt-auto hoverEffect xl:ml-auto xl:-mr-5 px-4 py-2" onClick={signOut}>
